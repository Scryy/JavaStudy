 ...
 */
public class MotionSquare2 extends JPanel implements ActionListener {
	...
	int oscFrameNumber;			// Oscilatting frame number
        
        g.drawString( "Oscillating Motion", 40, 50 );

	oscFrameNumber = frameNumber % (2*450);

	if ( oscFrameNumber > 450 ) {
		oscFrameNumber = (2*450) - oscFrameNumber;
	}

	g.setColor(Color.BLACK);
	g.fillRect(oscFrameNumber, 100, 150, 150);
