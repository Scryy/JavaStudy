 ...
 */
public class MotionSquare extends JPanel implements ActionListener {
	...
	int cyclicFrameNumber;	// Cyclic frame number; This will control the velocity
				// and starting ' x ' position of the square

        
        g.drawString( "Cyclic Motion", 40, 50 );


	cyclicFrameNumber = frameNumber % 450;			// Will repeate animation every 450 frames
								// Based on the size of our drawing window
								// this will cause the square to hit the 
								// lefternmost edge.
	g.setColor(Color.BLACK);
	g.fillRect(cyclicFrameNumber, ( height / 4 ), 150, 150);		// Our x position is determined by the frame
										// Number. Y is a quarter way down the page
    ...
    public static void main(String[] args) {
         ...
         */
        MotionSquare drawingArea = new MotionSquare();
